...
public class AuthService : IAuthService
{
    ...
    public async Task<RegisterResponse> RegisterAsync(RegisterRequest request)
    {
        ...
        // Protect against null Phone by normalizing safely
        ...
        try
        {
            ...
            // Generate temporary6-digit numeric password
    ...
    {
        // generate secure6-digit numeric string
    ...
    public async Task<TokenResponse> LoginAsync(LoginRequest request)
    {
        ...
        var user = await _context.Users
            .Include(u => u.Status)
            .FirstOrDefaultAsync(u => u.Email != null && EF.Functions.ILike(u.Email, emailToMatch));
