...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> ForgotPassword([FromBody] ForgotPasswordRequest request)
    {
        ...
        {
            _logger.LogError(ex, "ForgotPassword failed for {Email}", request?.Email);
            return StatusCode(500, new { message = "Lỗi hệ thống!" });
        }
    }
    ...
    public async Task<IActionResult> ResendOtp([FromBody] ForgotPasswordRequest request)
    {
        ...
        {
            _logger.LogError(ex, "ResendOtp failed for {Email}", request?.Email);
            return StatusCode(500, new { message = "Lỗi hệ thống!" });
        }
    }
    ...
    public async Task<IActionResult> VerifyOtp([FromBody] VerifyOtpRequest request)
    {
        ...
        try
        {
            var resetToken = await _authService.VerifyPasswordResetOtpAsync(request.Email, request.Otp);
        ...
        {
            // Log exception to help debugging500 errors from frontend
            _logger.LogError(ex, "VerifyOtp failed for {Email}", request?.Email);
            return StatusCode(500, new { message = "Lỗi hệ thống!" });
        }
    }
    ...
    public async Task<IActionResult> ResetPassword([FromBody] ResetPasswordRequest request)
    {
        ...
        try
        {
            await _authService.ResetPasswordWithTokenAsync(request.ResetToken, request.NewPassword);
